...
const getMenuItems = () => {
  const items: Array<{ name: string; href: string; external?: boolean }> = [
    { name: "Home", href: "#hero" },
    { name: "About", href: "#features" },
    { name: "Our Startup Portfolio", href: "https://www.codeandcreed.tech/", external: true },
...
export const Navbar = ({
  ...
  const dashboardText = "Book A Discovery Call";
  const dashboardButtonClassName =
    "bg-[#f5f5f5] text-[#0f0f0f] hover:bg-[#ebebeb] dark:bg-[#f5f5f5] dark:text-[#0f0f0f] dark:hover:bg-[#ebebeb]";
